...
Join my [update channel](https://t.me/EvasUpdates) & [support group](https://t.me/EvasSupport), to stay in touch with my new updates, to ask your doubts about the bot & to report the bugs.
...
But,for now, I don’t need any donations...🙃."""
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=[[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)")],
